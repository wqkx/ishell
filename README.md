...
> **Latest release:** [v0.24.5](https://github.com/wqkx/ishell/releases/tag/v0.24.5)
...
- There's an entry (saying the window was minimized/occluded) → only the UI thread was blocked, the process is alive.
