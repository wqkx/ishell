...
pub(super) fn build_find_regex(pat: &str, case: bool, word: bool, regex_mode: bool) -> Option<regex::Regex> {
    let p = if regex_mode {
        pat.to_string()
    } else {
...
pub(super) fn find_widget(ui: &mut egui::Ui, ed: &mut Editor, text_id: egui::Id, caret_byte: usize) -> FindOut {
