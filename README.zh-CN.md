...
| 指标 | 数值 |
|---|---|
| 二进制 | 单文件，约 **29 MB**（含内置等宽中文字体；无运行时依赖、无后台守护进程） |
...
终端/编辑器内置（子集化的）[**Sarasa Mono SC（更纱黑体等距）**](https://github.com/be5invis/Sarasa-Gothic)，
Latin 半角与中文全角严格 **1:2**，等宽网格里中英对齐、无多余间距。遵循 SIL Open Font License 1.1，
许可见 [assets/SarasaMonoSC-LICENSE.txt](assets/SarasaMonoSC-LICENSE.txt)。
